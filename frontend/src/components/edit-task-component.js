...
export default class EditTask extends Component {
    ...
    constructor(props) {
        ...
        this.onClickDelay = this.onClickDelay.bind(this);
    ...
    async onClickDelay(){
        console.log(this.state.currentTask._id);

        try {
            const { _id } = this.state.currentTask;
            const response = await TaskService.delayTaskById(_id);
            this.setState({
                message: 'Successfully delay the task',
            });
            // this.retrieveCurrentTask();
            ...
            console.log(err);
            this.setState({
                delayMessage: 'Failed to delay the task.',
            });
        }
    }
